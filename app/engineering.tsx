...
export default function EngineeringScreen() {
  ...
  return (
    ...
    >
      <CodexReveal index={0}>
        {/* Masthead canon · ENGINEERING. StatusPill mantido. */}
        <PressableTextScale onPress={() => router.replace('/edicao')} hitSlop={8} accessibilityLabel="voltar para edição">
          <Masthead title="ENGINEERING" folio={null} />
        </PressableTextScale>
        <EditorialDateline date={editorialDateLine()} edition="laboratório interno · qualidade · regressão · gates" />
