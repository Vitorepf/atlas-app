...
- [ ] R7 [ ] R8 [ ] R9 (pendentes — restam no client ~3220L: inbox, voice, devices, mac, cartografia, cognitive, memory, semantic, bitacula, mission, screen-time-config; mais entrelaçados/menores → retorno decrescente. client.ts já −66% (9401→3220).)
