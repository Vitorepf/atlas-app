...
- [ ] R6 [ ] R7 [ ] R8 [ ] R9 (pendentes — domínios restantes no client ~4481L: projects, tasks, agenda, routines, inbox, voice, devices, mac, cartografia, cognitive, memory, semantic, bitacula)
